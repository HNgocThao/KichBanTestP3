...
import BaiTap.Actions.PageObjects.TodoObject;
...
public class TC06_AddTodo extends BaseTest {
    ...
    public void Test_AddTodo(HashMap<String, String> data){
        TodoObject.AddTodo(driver, data.get("title"));
    }
