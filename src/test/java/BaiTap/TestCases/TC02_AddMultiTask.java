...
import BaiTap.Actions.PageObjects.MultiTaskObject;
...
public class TC02_AddMultiTask extends BaseTest {
    ...
    public void Test_AddMultiTask(HashMap<String, String> data){
        MultiTaskObject.AddMultiTask(driver, data.get("title"), data.get("project"));
    }
