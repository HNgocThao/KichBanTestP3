...
import BaiTap.Actions.PageObjects.ProjectTimeObject;
...
public class TC03_AddProjectTime extends BaseTest {
    ...
    public void Test_AddProjectTime(HashMap<String, String> data){
        ProjectTimeObject.AddProjectTime(driver, data.get("project"), data.get("start_date"),
                data.get("end_date"), data.get("end_date"), data.get("end_time"));
    }
