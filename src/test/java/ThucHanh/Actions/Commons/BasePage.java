package ThucHanh.Actions.Commons;
...
//    }
    ...
    public void sendKeyToElementClick(WebDriver driver, String xpathExpression, String value){
        getElement(driver,xpathExpression).click();
        getElement(driver,xpathExpression).clear();
        getElement(driver,xpathExpression).sendKeys(value);
    }
    public void sendKeyToEnter(WebDriver driver, String xpathExpression, String value){
        getElement(driver,xpathExpression).clear();
        getElement(driver,xpathExpression).sendKeys(value);
        getElement(driver, xpathExpression).sendKeys(Keys.ENTER);
    }
